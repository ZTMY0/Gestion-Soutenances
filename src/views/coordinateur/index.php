        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-end">
                <div>
                    ...
                    <div class="mt-3">
                         <span class="badge bg-white text-primary me-2"></i>Admin</span>
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <span class="badge bg-warning text-dark"><i></i>À valider</span>
                                </div>
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <span class="badge bg-success"></i>À planifier</span>
                                </div>
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <span class="badge bg-primary"></i>Jurys</span>
                                </div>
