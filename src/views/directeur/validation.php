...
try {
    ...
    // En cas d'erreur sur la table PV, on logue l'erreur et on initialise un tableau vide
    error_log("Erreur SQL : " . $e->getMessage());
    $rows = []; 
    echo "<div class='alert alert-danger'>Erreur technique : La table 'pv' semble manquante dans la base de données.</div>";
}
?>
<!doctype html>
<html lang="fr">
