...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark py-3 mb-5">
        <div class="container">
            <span class="navbar-brand"><i class="fas fa-user-shield me-2"></i>Espace Sécurisé</span>
            <div class="d-flex">
            ...
            <div class="col-md-6">
                ...
                <div class="card shadow-sm border-0 rounded-3">
                    <div class="card-header bg-white py-3">
                        <h5 class="mb-0 fw-bold text-dark"><i class="fas fa-key me-2 text-primary"></i>Modifier mon mot de passe</h5>
                    </div>
                ...
                <div class="text-center mt-4 text-muted small">
                    <i class="fas fa-shield-alt me-1"></i> Vos données sont chiffrées selon les standards de sécurité UEMF.
                </div>
