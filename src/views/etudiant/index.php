...
$user_ip = getUserIP(); // IP Stockée ici
    ...
    <?php if (!$projet): ?>
        ...
        <div class="container text-center mt-5">
            <div class="card shadow-lg border-0 mx-auto p-5" style="max-width: 600px;">
                <div class="mb-4 text-primary opacity-25"><i class="fas fa-rocket fa-5x"></i></div>
                ...
                <div class="alert alert-info d-inline-block">
                    <i class="fas fa-network-wired me-2"></i>Votre IP : <?= $user_ip ?>
                </div>
                <br><br>
